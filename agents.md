...
**Latest Update**: WP POS v1.9.128 - Customer Attachment Fully Functional - checkout now properly attaches selected customer (not just logged-in cashier) to orders, customer data passed from cart to checkout API
