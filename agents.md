...
**Latest Update**: WP POS v1.9.117 - Streamlined Roles Display to Management Roles Only - simplified roles list to show only Administrator and Shop Manager (excluded customer, subscriber, and other non-management roles), made Shop Manager editable for capability assignment like custom roles, only Administrator is fully protected from editing
