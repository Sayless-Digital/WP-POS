...
**Latest Update**: WP POS v1.9.173 - Fixed Negative Totals for Returns - removed Math.max(0, total) constraints to allow negative totals when processing returns, ensures accurate display of refund amounts in cart and checkout modal
