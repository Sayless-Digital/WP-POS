...
<head>
    ...
    <!-- JPOS Components -->
    <script src="assets/js/components/ui/BaseComponent.js?v=1.7.3"></script>
    <script src="assets/js/components/search/OptionsSearch.js?v=1.7.3"></script>
    <script src="assets/js/components/search/AttributeSearch.js?v=1.7.3"></script>
    <script src="assets/js/components/forms/AttributeForm.js?v=1.7.3"></script>
    <script src="assets/js/components/index.js?v=1.7.3"></script>
    <!-- JPOS Original JavaScript (temporarily reverting for debugging) -->
    <script src="assets/js/main.js?v=1.7.3"></script>
    <style>
        /* Custom Scrollbar */
