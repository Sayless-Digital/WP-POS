...
<form method="POST" id="databaseForm">
    ...
    <button type="submit" name="test_connection" value="1" class="btn btn-secondary" style="width: 100%; margin-bottom: 20px;">
    ...
    <div class="buttons">
        ...
        <button type="submit" name="next_step" value="3" class="btn btn-primary" <?php echo !$success ? 'disabled' : ''; ?>>
            Next: Configuration →
        </button>
    </div>
</form>
