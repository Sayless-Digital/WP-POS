                            ...
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4">
                                    <button wire:click="toggleStatus({{ $user->id }})" 
                                        class="px-3 py-1 text-xs font-medium rounded-full {{ $user->is_active ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-800' }}">
            ...
            <div class="bg-white rounded-lg shadow-xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
                ...
                <form wire:submit.prevent="save">
                    <div class="p-6 space-y-4">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">Password {{ $editMode ? '' : '*' }}</label>
